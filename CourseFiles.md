...
<div style="width: 33%;float: left;">
    ...
    <center>
      <span class="fa-stack fa-4x">
          ...
          <a href="https://jbpost2.github.io/R4Reproducibility/slides/R4Reproducibility.html#1" target = "_blank">
          <i class="fa fa-list fa-stack-1x fa-inverse"></i></a>
      </span>
      <a href="https://jbpost2.github.io/R4Reproducibility/slides/R4Reproducibility.html#1" target = "_blank">
        <h4 class="service-heading">Slides - HTML Version</h4>
      </a>
        </center>
...
<div style="width: 33%;float: left;">
    ...
    <center>
      <span class="fa-stack fa-4x">
          <i class="fa fa-circle fa-stack-2x text-primary"></i>
          <a href="https://jbpost2.github.io/R4Reproducibility/slides/R4Reproducibility.pdf" target = "_blank">
          <i class="fa fa-list fa-stack-1x fa-inverse"></i></a>
      </span>
      <a href="https://jbpost2.github.io/R4Reproducibility/slides/R4Reproducibility.pdf" target = "_blank">
        <h4 class="service-heading">Slides - PDF Version</h4>
      </a>
        </center>
...
<div style="width: 33%;float: right;">
    ...
    <center>
      <span class="fa-stack fa-4x">
          <i class="fa fa-circle fa-stack-2x text-primary"></i>
          <a href="https://jbpost2.github.io/R4Reproducibility/slides/R4Reproducibility.R" target = "_blank">
          <i class="fa fa-list fa-stack-1x fa-inverse"></i></a>
      </span>
      <a href="https://jbpost2.github.io/R4Reproducibility/slides/R4Reproducibility.R" target = "_blank">
        <h4 class="service-heading">Just the R Code from the Slides</h4>
      </a>
    </center>
...
<div style="width: 33%;float: left;">
    ...
    <center>
            <span class="fa-stack fa-4x">
                <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    <a href="https://github.com/jbpost2/R4Reproducibility/raw/main/cheatsheets/rstudio-ide.pdf" target="_blank">
...
<div style="width: 33%;float: left;">
    ...
    <center>
        <span class="fa-stack fa-4x">
            <i class="fa fa-circle fa-stack-2x text-primary"></i>
                <a href="https://github.com/jbpost2/R4Reproducibility/raw/main/cheatsheets/base-r.pdf" target="_blank">
...
<div style="width: 33%;float: left;">
    ...
    <center>
        <span class="fa-stack fa-4x">
            <i class="fa fa-circle fa-stack-2x text-primary"></i>
                <a href="https://github.com/jbpost2/R4Reproducibility/raw/main/cheatsheets/data-import.pdf" target="_blank">
...
<div style="width: 33%;float: left;">
    ...
    <center>
        <span class="fa-stack fa-4x">
            <i class="fa fa-circle fa-stack-2x text-primary"></i>
                <a href="https://github.com/jbpost2/R4Reproducibility/raw/main/cheatsheets/rmarkdown-reference.pdf" target="_blank">
...
<div style="width: 33%;float: left;">
    ...
    <center>
            <span class="fa-stack fa-4x">
                <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    <a href="https://github.com/jbpost2/R4Reproducibility/raw/main/cheatsheets/data-transformation.pdf" target="_blank">
...
<div style="width: 33%;float: left;">
    ...
    <center>
        <span class="fa-stack fa-4x">
            <i class="fa fa-circle fa-stack-2x text-primary"></i>
                <a href="https://github.com/jbpost2/R4Reproducibility/raw/main/cheatsheets/data-visualization-2.1.pdf" target="_blank">
